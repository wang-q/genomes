...
nwr reroot ../MinHash/tree.nwk -n Lis_mono_EGD_e -n Staphyloc_aure_aureus_NCTC_8325 |
...
|--------------------------------|-----------|
| Proteins                       | 5,046,137 |
| Unique headers and annotations | 4,928,597 |
| Unique proteins                | 4,918,223 |
| all.replace.fa                 | 5,046,137 |
| all.annotation.tsv             | 5,046,138 |
| all.info.tsv                   | 5,046,138 |
...
cat HMM/marker.lst |
    ...
    ' |
    paste - - |
    tsv-filter --invert --ge 2:900 --le 2:1400 |
    cut -f 1 \
...
nw_reroot ../Protein/bac120.trim.newick Lis_mono_EGD_e Staphyloc_aure_aureus_NCTC_8325 |
    nwr order stdin --nd --an \
    > bac120.reroot.newick

nwr pl-condense -r genus \
    bac120.reroot.newick ../Protein/species.tsv  |
    nwr order stdin --nd --an \
